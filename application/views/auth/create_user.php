<div id="content-top">
    ...
    <a href='/auth/' class='bforward'><?=lang('web_back_to_list')?></a>
...
echo ($updType == 'create') ? form_open_multipart('auth/create', $attributes) : form_open_multipart('auth/edit', $attributes); 
?>
